...
type ExecutionPlanRow struct {
	...
	PlanGeneratedTimestamp sql.NullString // Date and time when the execution plan was generated (from V$SQL_PLAN.TIMESTAMP) - renamed to avoid collision with NRDB's timestamp field
